...
var navLoopCtrl = function($scope) {
    $scope.navitems = [
        ...
        {"class":"","href":"#","text":"リリースアプリ","_blank":"true","dropdown":"true","navchildren":[{"href":"https://itunes.apple.com/jp/app/practice-camera-xie-zhen-gou/id954811892?mt=8&uo=4","text":"practice-camera"}]},
		...
		{"class":"","href":"#","text":"ソーシャルメディア","_blank":"true","dropdown":"true","navchildren":[{"href":"https://twitter.com/OEDORoulette","text":"開発者Twitter"},{"href":"http://shiftswift.blogspot.jp/","text":"Swift体験記"}]},
    ];
}
